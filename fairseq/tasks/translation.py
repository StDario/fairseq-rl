...
class TranslationTask(FairseqTask):
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, left_pad_source=True):
        return LanguagePairDataset(src_tokens, src_lengths, self.source_dictionary, left_pad_source=left_pad_source)
