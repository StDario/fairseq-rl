...
class SacrebleuDeltaScorer(object):
    ...
    def score(self, order=4):
        ...
        scores = []
        for r, s in zip(self.ref, self.sys):
            for i in range(len(s)):
                if i == 0:
                    scores.append(self.sacrebleu.sentence_bleu(s, r[i]))
                else:
                    scores.append(self.sacrebleu.sentence_bleu(s, r[:i]) - self.sacrebleu.sentence_bleu(s, r[:i-1]))
